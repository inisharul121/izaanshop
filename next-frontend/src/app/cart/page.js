              ...
              >
                ...
                <div className="flex-1 flex flex-col justify-between">
                  <div className="flex justify-between items-start gap-4">
                    <div>
                      <Link href={`/product/${item.slug}`} className="font-bold text-dark hover:text-primary transition-colors text-lg line-clamp-1">
                        {item.name}
                      </Link>
          ...
          <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm sticky top-24">
            ...
            {!user && (
              <p className="text-xs text-gray-400 text-center mt-3">
                Have an account?{' '}
                <Link href="/login?redirect=checkout" className="text-primary font-bold hover:underline">
                  Sign in
                </Link>
                {' '}for faster checkout
              </p>
