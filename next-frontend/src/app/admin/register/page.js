    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-900 px-4">
        <div className="max-w-md w-full bg-white rounded-3xl shadow-2xl p-10 text-center">
          ...
          <Link href="/admin/login" className="btn-primary w-full py-4 rounded-2xl font-black block text-center">
            Return to Login
          </Link>
        </div>
      </div>
      ...
      <div className="max-w-md w-full bg-white rounded-3xl shadow-2xl p-10 border border-gray-100 overflow-hidden relative">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <button 
            disabled={loading} 
            type="submit" 
            className="w-full bg-primary hover:bg-primary/90 text-white py-4 rounded-2xl font-black text-sm transition-all shadow-xl shadow-primary/20 flex items-center justify-center gap-3 disabled:bg-gray-200 disabled:shadow-none"
          >
        ...
        <div className="mt-10 pt-8 border-t border-gray-50 text-center">
            ...
            <Link href="/admin/login" className="text-primary hover:underline font-black mt-1 inline-block">Login to Dashboard</Link>
        </div>
      </div>
    </div>
  );
